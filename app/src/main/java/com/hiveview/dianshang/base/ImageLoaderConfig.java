...
public class ImageLoaderConfig {
    ...
    private final static String tag = "ImageLoaderConfig";
    ...
    private static final int MAX_DISK_SMALL_CACHE_SIZE = 100 * ByteConstants.MB;
...
//            }
            ...
            memoryTrimmableRegistry.registerMemoryTrimmable(new MemoryTrimmable() {
                ...
                public void trim(MemoryTrimType trimType) {
                    ...
                    Utils.print(tag,String.format("Fresco onCreate suggestedTrimRatio : %d", suggestedTrimRatio));
                    ...
                    if (MemoryTrimType.OnCloseToDalvikHeapLimit.getSuggestedTrimRatio() == suggestedTrimRatio
                        ...
                        // 清除内存缓存
                        Utils.print(tag,"clear fresco cache");
